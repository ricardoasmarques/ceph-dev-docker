...
Setup SSO on Ceph Dashboard:
    ...
    # bin/ceph dashboard sso-saml2-setup https://cephdashboard.local  https://localhost:9443/idp/shibboleth uid https://cephdashboard/idp \
...
Setup `shibboleth` IdP:
    ...
    # curl https://cephdashboard.local/auth/saml/metadata --output /opt/shibboleth-idp/metadata/cephdashboard-metadata.xml --insecure
